...
const Globe: React.FC<GlobeProps> = ({
  ...
  const globeRef = useRef<COBEGlobe | null>(null); // To store the cobe globe instance
    ...
    const initGlobe = () => {
      ...
      const render = () => {
        ...
        globeRef.current?.update({
          phi: phiRef.current,
          theta: thetaRef.current, // Ensure cobe uses the updated thetaRef
        });
  ...
  return (
    ...
    >
      <canvas
        ref={canvasRef}
        style={{
          width: "100%", // Canvas follows the responsive globe container
          height: "100%",
